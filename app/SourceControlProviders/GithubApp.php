...
class GithubApp extends AbstractSourceControlProvider
{
    ...
    public function getRepos(bool $useCache = true): array
    {
        ...
        try {
            ...
            throw $this->friendlyFetchError($e, 'GitHub App', 'fetch repositories');
        }
    }
    ...
    public function getBranches(string $repo, bool $useCache = true): array
    {
        ...
        try {
            ...
            throw $this->friendlyFetchError($e, 'GitHub App', 'fetch branches');
        }
    }
    ...
    public function getFile(string $repo, string $path, ?string $branch = null): ?string
    {
        try {
            ...
            Log::warning('Failed to fetch GitHub App file content', [
                'repo' => $repo,
                'path' => $path,
                'error' => $e->getMessage(),
            ]);
