                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead>Per GB RAM</TableHead>
                          ...
                          >
                            ...
                            <TableCell>
                              <div className="grid gap-1">
                                ...
                                <span className="text-muted-foreground text-xs">{money(plan.hourlyEur)}/hr</span>
                              </div>
                            </TableCell>
                            <TableCell>{money(plan.monthlyEur / plan.cpu)}</TableCell>
                            <TableCell>{money(plan.monthlyEur / plan.ram)}</TableCell>
                            <TableCell>
                              {selected && (
